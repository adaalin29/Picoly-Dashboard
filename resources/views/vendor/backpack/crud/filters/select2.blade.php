...
<li filter-name="{{ $filter->name }}"
    ...
    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" test="{{$filter->label}}">{{ $filter->label == 'Restaurant' ? 'Selecteaza restaurantul' : $filter->label }} <span class="caret"></span></a>
