...
@section('header')
	<section class="content-header">
	  ...
	  <ol class="breadcrumb">
	    ...
	    <li><a class="text-capitalize btnMiddleCrud">{{ $crud->entity_name_plural }}</a></li>
...
@if ($crud->hasAccess('list'))
	<a href="digital_categories?id_restaurant={{request()->id_restaurant.'&id_menu='.request()->id_menu}}&layout=0" class="hidden-print"><i class="fa fa-angle-double-left" style="margin-bottom: 25px;"></i> Back</a>
@endif
<!-- Default box -->
  <div class="row">
